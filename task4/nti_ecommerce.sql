...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 17, 2022 at 07:45 AM
...
CREATE TABLE `coupons` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `code` bigint(5) UNSIGNED NOT NULL,
  `discount` tinyint(3) UNSIGNED NOT NULL,
  `discount_type` varchar(32) NOT NULL,
  `mini_order_value` smallint(4) UNSIGNED NOT NULL,
  `max_discount_value` smallint(3) UNSIGNED NOT NULL,
  `max_number_of_usage` tinyint(2) UNSIGNED NOT NULL,
